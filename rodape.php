        ...
        <div class="col-sm-6 col-md-4">
            <div class="panel-footer" style="background: none;">
                ...
                <address>
                    ...
                    &nbsp;
                    <a href="mailto:contato@branerscarnes.com.br?subject=Contato do Site&cc=adahorapirola@gmail.com">
                        Contato@branerscarnes.com.br
                    </a>
                </address>
                <div class="embed-responsive embed-responsive-4by3">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.794709742119!2d-46.45865274891928!3d-23.53988498461848!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce66bf222d207b%3A0x1939a901dce47f36!2sAv.%20Itaquera%2C%208266%20-%20Vila%20Carmosina%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2008295-000!5e0!3m2!1spt-BR!2sbr!4v1674235516983!5m2!1spt-BR!2sbr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
        <!-- final area de locallização  -->
        <div class="col-sm-6 col-md-4">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li>
                        <a href="index.php#destaques" class="text-danger">
                            <span class="glyphicon glyphicon-ok-sign">&nbsp;Destaques</span>
                        </a>
                    </li>
                    <li>
                ...
                <form action="rodape_contato_envia.php" name="form_contato" id="form_contato" method="post">
                    ...
                    <p>
                        <span class="input-group">
                            ...
                            <textarea name="comentario_contato" cols="30" rows="5" placeholder="digite seu comentário" aria-describedby="basic-addon3" class="form-control" required></textarea>
                        </span>
                    </p>
                    <p>
        ...
        <div class="col-sm-12">
            <div class="panel-footer" style="background: none;">
                <h6 class="text-danger text-center">
                    Desenvolvido por Andrey da Hora Pirola&trade; 2023
                    <br>
                    <a href="https://github.com/Notsumez" target="_blank">Gituhub/Notsumez.com.br</a>
                </h6>
            </div>
        </div>
    </div>
